...
import FBSDKCoreKit
import Alamofire
class InfoViewController: UIViewController,UIScrollViewDelegate,UITextViewDelegate{
    ...
    func getProfile(){
        ...
        do{
            ...
            about.font = UIFont(name: "Helvetica Neue", size: 12)
            setScreen()
            ...
            for i in 0...self.user[0].stat.count-1{
                sum += user[0].stat[i].valueForKey("commented") as! Int
            }
            }
