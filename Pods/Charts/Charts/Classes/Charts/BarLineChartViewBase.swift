...
public class BarLineChartViewBase: ChartViewBase, BarLineScatterCandleBubbleChartDataProvider, NSUIGestureRecognizerDelegate
{
    ...
    internal override func initialize()
    {
        ...
        _tapGestureRecognizer = NSUITapGestureRecognizer(target: self, action: "BarLineChartViewBase.tapGestureRecognized(_:):")
        _doubleTapGestureRecognizer = NSUITapGestureRecognizer(target: self, action: "BarLineChartViewBase.doubleTapGestureRecognized(_:):")
        _doubleTapGestureRecognizer.nsuiNumberOfTapsRequired = 2
        _panGestureRecognizer = NSUIPanGestureRecognizer(target: self, action: "BarLineChartViewBase.panGestureRecognized(_:):")
        ...
        #if !os(tvOS)
            _pinchGestureRecognizer = NSUIPinchGestureRecognizer(target: self, action: "BarLineChartViewBase.pinchGestureRecognized(_:):")
        ...
        else if (recognizer.state == NSUIGestureRecognizerState.Ended || recognizer.state == NSUIGestureRecognizerState.Cancelled)
        {
            if (_isDragging)
            {
                if (recognizer.state == NSUIGestureRecognizerState.Ended && isDragDecelerationEnabled)
                {
                    ...
                    _decelerationDisplayLink = NSUIDisplayLink(target: self, selector: "BarLineChartViewBase.decelerationLoop:")
